...
const authRoutes = require('../Hackx-2026/backend/modules/auth/authRoutes');
const branchRoutes = require('../Hackx-2026/backend/modules/branches/branchRoutes');
const staffRoutes = require('../Hackx-2026/backend/modules/staff/staffRoutes');
const reviewRoutes = require('../Hackx-2026/backend/modules/reviews/reviewRoutes');
const responseRoutes = require('../Hackx-2026/backend/modules/responses/responseRoutes');
